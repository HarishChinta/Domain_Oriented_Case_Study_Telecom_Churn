# Domain_Oriented_Case_Study_Telecom_Churn
Domain-Oriented Case Study_Submission by Yaswanth Harish and Thejus
# Telecom Churn Case Study
# Case Study submission by Thejus and Yaswanth Harish 
## Problem Statement
...
The dataset can be downloaded from [here](https://drive.google.com/file/d/1SWnADIda31mVFevFcfkGtcgBHTKKI94J/view). The file is also submitted along with the python notebook file.
